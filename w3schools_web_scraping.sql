/*
Make sure you have a database created with name 'w3_db'

*/

CREATE TABLE [w3_db].[dbo].Categories (
...
CREATE TABLE [w3_db].[dbo].Customers (
...
(58,	'Pericles Comidas clásicas',	'GuillermoFernández',	'Calle Dr. Jorge Cash 321',	'México D.F.',	'05033',	'Mexico'),
...
CREATE TABLE [w3_db].[dbo].Employees (
...
CREATE TABLE w3_db.[dbo].Products (
...
(69,'Gudbrandsdalsost',	15,	4,	'10 kg pkg.',360),
...
CREATE TABLE [w3_db].[dbo].Shippers (
	ShipperID int PRIMARY KEY,
	ShipperName varchar(50) NOT NULL,
	Phone varchar(20) NOT NULL
);

INSERT INTO [w3_db].[dbo].Shippers
VALUES
...
CREATE TABLE [w3_db].[dbo].OrderDetails (
...
-- Suppliers info is missing will be added later on.

/*
To drop the tables use

DROP TABLE [w3_db].[dbo].Categories;
DROP TABLE [w3_db].[dbo].Customers;
DROP TABLE [w3_db].[dbo].Employees;
DROP TABLE [w3_db].[dbo].OrderDetails;
DROP TABLE [w3_db].[dbo].Orders;
DROP TABLE [w3_db].[dbo].Products;
DROP TABLE [w3_db].[dbo].Shippers;
*/