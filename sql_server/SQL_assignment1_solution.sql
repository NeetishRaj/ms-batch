...
-- Below Query gives us the report but without adding Quantity
SELECT 
	Products.ProductID, 
	Products.ProductName, 
	OrderDetails.Quantity AS 'Total Units Sold'

FROM OrderDetails 
INNER JOIN Products 
ON OrderDetails.ProductID = Products.ProductID

-- Below query would give us the Summed up version of 'Total Units sold'
SELECT 
	ProductID, 
...
-- Final answer is by doing the INNER JOIN and Group
